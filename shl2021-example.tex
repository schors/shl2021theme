...
% for listings
\definecolor{lstbg}{HTML}{FDF6E3}
\definecolor{lsttext}{HTML}{586E75}
\definecolor{lstmark}{HTML}{EEE8D5}
\definecolor{lstrule}{HTML}{93A1A1}
\definecolor{lstcomm}{HTML}{657B83}
\definecolor{lstkey}{HTML}{859900}
\definecolor{lststring}{HTML}{DC322F}
\lstset{
        columns=flexible,
        keepspaces=true,
        ...
        tabsize=4,
        frame=single,
        basicstyle=\fontsize{10pt}{12}\bf\ttfamily\color{lsttext},
        backgroundcolor=\color{lstbg},
        commentstyle=\color{lstcomm},
...
% 
\newcommand<>{\btLstHL}[1]{%
\only#2{\btIfInRange{\value{lstnumber}}{#1}{\color{lstmark}\def\lst@linebgrdcmd{\color@block}}{\def\lst@linebgrdcmd####1####2####3{}}}%
}%
\makeatother
